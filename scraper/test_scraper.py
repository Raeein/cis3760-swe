...
def testGetJobCardFromIndeed1():
    ...
    listLength = scraper.getJobCardsFromHTML(job_board_file_1.read(), "Indeed")
...
def testGetJobCardFromIndeed2():
    ...
    listLength = scraper.getJobCardsFromHTML(job_board_file_2.read(), "Indeed")
...
def testGetJobCardFromIndeed3():
    ...
    listLength = scraper.getJobCardsFromHTML(job_board_file_3.read(), "Indeed")
...
def testGetJobTitleFromIndeed1():
    ...
    title1 = scraper.getJobAttribute(job_file_1.read(), "job_title", "Indeed")
    job_file_1.close()
    assert title1 == "Cloud Solutions Engineer - .NET and Azure"

def testGetJobCompanyFromIndeed1():
    job_file_1 = open("testWebsite/indeed/indeedJob1.txt", "r", encoding="utf8")
    company1 = scraper.getJobAttribute(job_file_1.read(), "job_company", "Indeed")
    job_file_1.close()
    assert company1 == "Aviso Wealth"

def testGetJobLocationFromIndeed1():
    job_file_1 = open("testWebsite/indeed/indeedJob1.txt", "r", encoding="utf8")
    location1 = scraper.getJobAttribute(job_file_1.read(), "job_location", "Indeed")
    job_file_1.close()
    assert location1 == "151 Yonge Street, Toronto, ON"

def testGetJobEmploymentFromIndeed1():
    job_file_1 = open("testWebsite/indeed/indeedJob1.txt", "r", encoding="utf8")
    company1 = scraper.getJobAttribute(job_file_1.read(), "job_employment", "Indeed")
    job_file_1.close()
    assert company1 == "Full-time"

def testGetJobPayFromIndeed1():
    job_file_1 = open("testWebsite/indeed/indeedJob1.txt", "r", encoding="utf8")
    pay1 = scraper.getJobAttribute(job_file_1.read(), "job_pay", "Indeed")
    job_file_1.close()
...
def testGetJobTitleFromIndeed2():
    ...
    title2 = scraper.getJobAttribute(job_file_2.read(), "job_title", "Indeed")
    job_file_2.close()
    assert title2 == "Junior Java Developer"

def testGetJobCompanyFromIndeed2():
    job_file_2 = open("testWebsite/indeed/indeedJob2.txt", "r", encoding="utf8")
    company2 = scraper.getJobAttribute(job_file_2.read(), "job_company", "Indeed")
    job_file_2.close()
    assert company2 == "Triunity Software"

def testGetJobLocationFromIndeed2():
    job_file_2 = open("testWebsite/indeed/indeedJob2.txt", "r", encoding="utf8")
    location2 = scraper.getJobAttribute(job_file_2.read(), "job_location", "Indeed")
    job_file_2.close()
    assert location2 == "Toronto, ON"

def testGetJobEmploymentFromIndeed2():
    job_file_2 = open("testWebsite/indeed/indeedJob2.txt", "r", encoding="utf8")
    company2 = scraper.getJobAttribute(job_file_2.read(), "job_employment", "Indeed")
    job_file_2.close()
    assert company2 == "Full-time"

def testGetJobPayFromIndeed2():
    job_file_2 = open("testWebsite/indeed/indeedJob2.txt", "r", encoding="utf8")
    pay2 = scraper.getJobAttribute(job_file_2.read(), "job_pay", "Indeed")
    job_file_2.close()
...
def testGetJobTitleFromIndeed3():
    ...
    title3 = scraper.getJobAttribute(job_file_3.read(), "job_title", "Indeed")
    job_file_3.close()
    assert title3 == "Senior Software Engineer | Python Developer"

def testGetJobCompanyFromIndeed3():
    job_file_3 = open("testWebsite/indeed/indeedJob3.txt", "r", encoding="utf8")
    company3 = scraper.getJobAttribute(job_file_3.read(), "job_company", "Indeed")
    job_file_3.close()
    assert company3 == "Scotiabank"

def testGetJobLocationFromIndeed3():
    job_file_3 = open("testWebsite/indeed/indeedJob3.txt", "r", encoding="utf8")
    location3 = scraper.getJobAttribute(job_file_3.read(), "job_location", "Indeed")
    job_file_3.close()
    assert location3 == "40 King Street West, Toronto, ON"

def testGetJobEmploymentFromIndeed3():
    job_file_3 = open("testWebsite/indeed/indeedJob3.txt", "r", encoding="utf8")
    company3 = scraper.getJobAttribute(job_file_3.read(), "job_employment", "Indeed")
    job_file_3.close()
    assert company3 == "Permanent"

def testGetJobPayFromIndeed3():
    job_file_3 = open("testWebsite/indeed/indeedJob3.txt", "r", encoding="utf8")
    pay3 = scraper.getJobAttribute(job_file_3.read(), "job_pay", "Indeed")
    job_file_3.close()
    assert pay3 == "Unknown"
...
def testGetJobCardFromCanadianJob():
    ...
    listLength = scraper.getJobCardsFromHTML(job_board_file_4.read(), "Canadian Job Bank")
...
def testGetJobTitleFromCanadaJob():
    ...
    title1 = scraper.getJobAttribute(job_file_1.read(), "job_title", "Canadian Job Bank")
    job_file_1.close()
    assert title1 == "software engineer"

def testGetJobCompanyFromCanadaJob():
    job_file_1 = open("testWebsite/canadian_job/CanadianJob1.txt", "r", encoding="utf8")
    company1 = scraper.getJobAttribute(job_file_1.read(), "job_company", "Canadian Job Bank")
    job_file_1.close()
    assert company1 == "Micharity Inc"

def testGetJobLocationFromCanadaJob():
    job_file_1 = open("testWebsite/canadian_job/CanadianJob1.txt", "r", encoding="utf8")
    location1 = scraper.getJobAttribute(job_file_1.read(), "job_location", "Canadian Job Bank")
    job_file_1.close()
    assert location1 == "Toronto, ON"

def testGetJobEmploymentFromCanadaJob():
    job_file_1 = open("testWebsite/canadian_job/CanadianJob1.txt", "r", encoding="utf8")
    company1 = scraper.getJobAttribute(job_file_1.read(), "job_employment", "Canadian Job Bank")
    job_file_1.close()
    assert company1 == "Permanent employmentFull time"

def testGetJobPayFromCanadaJob():
    job_file_1 = open("testWebsite/canadian_job/CanadianJob1.txt", "r", encoding="utf8")
    pay1 = scraper.getJobAttribute(job_file_1.read(), "job_pay", "Canadian Job Bank")
    job_file_1.close()
